object FunctionWithImplicitParams {
  ...
  def main (args: Array[String]): Unit = {
    ...
    implicit val discount: Double = 0.2
    ...
    println(
      s"Total cost with discount of 5 " +
        s"Glazed Donuts, manually passed-through = " +
        s"${totalCost2("Glazed Donut", 5)(0.1, "Scala Donut Store")}")
  }
}
